...
import type { AnalyzedSession, BudgetKey, SubagentRef } from "./types.ts";
...
${renderSubagents(a)}
${renderMethodology(a)}
<footer>Generated by <a href="https://github.com/Mark-Life/agent-skills/tree/main/skills/inspect-and-debug/session-report" target="_blank" rel="noopener">session-report</a> · ${esc(a.provider)} · ${esc(a.sessionId)} · created by <a href="https://andrey-markin.com" target="_blank" rel="noopener">andrey-markin.com</a></footer>
</div>
